      ...
      <Tabs value={activeTab} onValueChange={(val) => { setActiveTab(val); setSelectedCategory('all'); }}>
        ...
        <TabsContent value="traditional" className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card>
              <CardContent className="pt-6">
                <div className="text-center">
                  <div className="text-3xl font-bold">{filteredByTab?.length || 0}</div>
                  <p className="text-sm text-gray-600 mt-1">Traditional Providers</p>
                </div>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-6">
                <div className="text-center">
                  <div className="text-3xl font-bold">{filteredByTab?.filter(p => p.is_operational).length || 0}</div>
                  <p className="text-sm text-gray-600 mt-1">Operational</p>
                </div>
              </CardContent>
            </Card>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12 text-gray-500">No traditional providers found</div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredProviders.map(provider => (
                <Card key={provider.id} className="hover:shadow-lg transition-shadow">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    {/* Blockchains (Web3) - removed for traditional tab */}
                    ...
                    <Dialog>
                      ...
                      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="space-y-4">
                          ...
                          {/* Blockchains - removed for traditional tab */}
        ...
        <TabsContent value="web3" className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card>
              <CardContent className="pt-6">
                <div className="text-center">
                  <div className="text-3xl font-bold">{filteredByTab?.length || 0}</div>
                  <p className="text-sm text-gray-600 mt-1">Web3 Providers</p>
                </div>
              </CardContent>
            </Card>
            <Card>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12 text-gray-500">No Web3 providers found</div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredProviders.map(provider => (
                <Card key={provider.id} className="hover:shadow-lg transition-shadow">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    {/* Coverage section removed based on outline */}
                    ...
                    {/* Compliance section removed based on outline */}
                      ...
                      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="space-y-4">
                          <div className="flex gap-2 flex-wrap">
                            ...
                            {/* Removed operational/inactive badges based on outline */}
                          </div>
                          ...
                          {/* Cons section removed based on outline */}
                          {/* Alternatives section removed based on outline */}
                        </div>
                      </DialogContent>
                    </Dialog>
                  </CardContent>
        ...
        <TabsContent value="lei" className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card>
              <CardContent className="pt-6">
                <div className="text-center">
                  <div className="text-3xl font-bold">{filteredByTab?.length || 0}</div>
                  <p className="text-sm text-gray-600 mt-1">LEI/vLEI Providers</p>
                </div>
              </CardContent>
            </Card>
            <Card>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12 text-gray-500">No LEI/vLEI providers found</div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredProviders.map(provider => (
                <Card key={provider.id} className="hover:shadow-lg transition-shadow">
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          ...
                          {/* Removed operational badge based on outline */}
                        </div>
                      </div>
                    </div>
                  </CardHeader>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    {/* Blockchains (Web3) removed based on outline */}
                    ...
                    {/* Response Time & Accuracy removed based on outline */}
                    {/* Compliance removed based on outline */}
                    ...
                    <Dialog>
                      ...
                      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="space-y-4">
                          ...
                          {/* Blockchains section removed based on outline */}
                          {/* Performance section removed based on outline */}
                          ...
                          {/* Pros & Cons sections removed based on outline */}
                          {/* Alternatives section removed based on outline */}
                        </div>
                      </DialogContent>
                    </Dialog>

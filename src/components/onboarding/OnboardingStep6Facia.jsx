    ...
    <div className="space-y-6">
      <div className="bg-purple-50 border-2 border-purple-200 rounded-xl p-6">
        <div className="flex items-start gap-3">
          <ScanFace className="h-6 w-6 text-purple-600 flex-shrink-0 mt-0.5" />
          <div>
            <h3 className="font-semibold text-purple-900 mb-2">Final Step: Identity Verification</h3>
      ...
      {verificationUrl && !verified && (
        <Card className="p-6 border-2 border-amber-200 bg-amber-50">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              <h3 className="font-semibold text-amber-900 mb-2">Verification Window Opened</h3>
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Your device camera will capture your face (30-60 seconds)</p>
            </div>
          </div>

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      ...
      <section className="relative overflow-hidden bg-white">
        ...
        {/* Powered By Section */}
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pb-8 sm:pb-12 border-t border-gray-200 pt-8 sm:pt-12">
          <div>
      ...
      <section className="py-12 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            <div className="p-4 sm:p-6 rounded-lg bg-white border border-gray-200 shadow-sm">
              ...
              <h3 className="text-base sm:text-lg font-bold mb-3 text-gray-900">Multi-Tenant Isolation</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
            {[
              ...
              <div key={i} className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-lg p-6 border border-gray-200">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#0066B3] flex items-center justify-center mb-4 text-white text-lg sm:text-xl font-bold">
                  {item.step}
                </div>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-base sm:text-xl text-center text-gray-600 mb-8 sm:mb-16">Purpose-built for your industry</p>

          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3 sm:gap-6 mb-8 sm:mb-16">
            {[
              {
                title: 'Crypto',
                path: 'CryptoSolution',
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8">
            {[
              ...
              <div key={i} className={`bg-gradient-to-br ${useCase.color} rounded-xl p-4 sm:p-8 border-2 ${useCase.border}`}>
                <h3 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6 text-gray-900">{useCase.title}</h3>
      ...
      <section className="py-12 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-2 sm:mb-3 text-gray-900">
            B2B SaaS Pricing
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div key={i} className={`rounded-2xl p-6 sm:p-8 ${plan.highlighted ? 'bg-gradient-to-br from-[#0066B3] to-[#004080] text-white shadow-2xl sm:scale-105' : 'bg-gray-50 text-gray-900 border-2 border-blue-100'}`}>
                <h3 className="text-xl sm:text-2xl font-bold mb-2">{plan.tier}</h3>
                <div className="mb-6">
                  <span className="text-3xl sm:text-4xl font-bold">{plan.price}</span>
                  {plan.price !== 'Custom' && <span className={`text-sm sm:text-base ${plan.highlighted ? 'text-blue-200' : 'text-gray-600'}`}>/month</span>}
                </div>
      ...
      {/* Call to Action */}
      <section className="py-12 sm:py-20 bg-gradient-to-br from-[#0066B3] via-[#004C8C] to-[#003366] text-white">
